...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <img class="img-error" src="{{ asset('assets/vendor/mazer/images/samples/error-403.png') }}" alt="Not Found">
        <div class="text-center">
            <h1 class="error-title">Unavailable</h1>
            <p class="fs-5 text-gray-600">You request is unavailable.</p>
